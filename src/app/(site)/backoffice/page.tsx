      ...
      <section className="relative py-28 bg-secondary overflow-hidden">
        ...
        <div className="container mx-auto px-4 max-w-6xl relative z-10 max-w-3xl">
          ...
          <p className="text-xl text-white/70 mb-10 leading-relaxed">
            Portal white-label com relatórios, conciliação automática, controle de
            estabelecimentos e API de integração — tudo em um único painel.
          </p>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              "Dashboard com TPV, margens e ticket médio",
